...
<body style="margin:1px;">
	...
	<div id="tb">
		<div>
			<a href="javascript:openTagAddDialog()" class="easyui-linkbutton" iconCls="icon-tag-add" plain="true">添加</a>
			<a href="javascript:openTagModifyDialog()" class="easyui-linkbutton" iconCls="icon-tag-edit" plain="true">修改</a>
			<a href="javascript:deleteTag()" class="easyui-linkbutton" iconCls="icon-tag-delete" plain="true">删除</a>
	 	...
	 	<form id="fm" method="post">
	 		<table cellspacing="8px">
	 			...
	 			<tr>
	 				<td>标签地址：</td>
	 				<td colspan="4">
	 					<input type="text" id="url" name="tag.url" value="product.action?s_product.smallType.id=" class="easyui-validatebox" required="true" validtype="" style="width:300px"/>
	 				</td>
	 			</tr>
	 		</table>
	 	</form>
