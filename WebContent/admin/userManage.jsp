...
if('${currentAdmin.name}' ==''){
	...
	function exportUsers(){
		...
		f.action = "user_doExportUser.action";
		f.method = "get";
		f.submit();
	}
</script>
...
<body style="margin:1px;">
	<table id="dg" title="会员管理" class="easyui-datagrid"
	...
	<div id="tb">
		<div>
			<a href="javascript:openUserAddDialog()" class="easyui-linkbutton" iconCls="icon-user-add" plain="true">添加</a>
			<a href="javascript:openUserModifyDialog()" class="easyui-linkbutton" iconCls="icon-user-edit" plain="true">修改</a>
			<a href="javascript:deleteUser()" class="easyui-linkbutton" iconCls="icon-user-delete" plain="true">删除</a>
			&nbsp;用户名：&nbsp;<input type="text" id="s_userName" size="20" onkeydown="if(event.keyCode==13) searchUser()"/>
			<a href="javascript:searchUser()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a>
			<a href="javascript:exportUsers()" class="easyui-linkbutton" iconCls="icon-exportExcel" plain="true">导出</a>
		</div>
	</div>
