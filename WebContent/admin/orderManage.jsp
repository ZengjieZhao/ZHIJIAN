...
if('${currentAdmin.name}' ==''){
	...
	function printPreview(){
		...
		var id = row.id;
		window.parent.addTab('发货单打印预览', 'order_printView.action?id='+id,'icon-print');
	}
	...
	function exportOrders(){
		...
		f.action = 'order_doExportOrder.action';
		f.method = "get";
		f.submit();
	} 
	function printOrder(){
...
<body style="margin:1px;">
	<table id="dg" title="订单管理" class="easyui-datagrid"
	 ...
	 <thead>
	 	<tr>
	 		...
	 		<th field="user.id" width="50" align="center" formatter="formatUserId">会员ID</th>
	 		<th field="user.userName" width="100" align="center" formatter="formatUserName">会员名称</th>
	 		<th field="createTime" width="100" align="center">下单时间</th>
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:modifyOrderStatus(2)" class="easyui-linkbutton" iconCls="icon-ok" plain="true">审核通过</a>
			<a href="javascript:modifyOrderStatus(3)" class="easyui-linkbutton" iconCls="icon-fahuo" plain="true">卖家已发货</a>
			<a href="javascript:modifyOrderStatus(6)" class="easyui-linkbutton" iconCls="icon-backOrderGo" plain="true">退单审核通过</a>
			<a href="javascript:modifyOrderStatus(7)" class="easyui-linkbutton" iconCls="icon-completeOrder" plain="true">完成退单</a>
			<a href="javascript:modifyOrderStatus(8)" class="easyui-linkbutton" iconCls="icon-cancelOrder" plain="true">取消订单</a>
			&nbsp;订单号：<input type="text" id="s_orderNo" size="20" />
			&nbsp;会员名称：<input type="text" id="s_userName" size="20" />
			<a href="javascript:searchOrder()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a><br>
			<a href="javascript:exportOrders()" class="easyui-linkbutton" iconCls="icon-exportExcel" plain="true">导出</a>
			<a href="javascript:printOrder()" class="easyui-linkbutton" iconCls="icon-print" plain="true">打印</a>
		</div>
	</div>
